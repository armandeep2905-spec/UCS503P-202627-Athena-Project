            ...
            {isAuthenticated && (
              <>
                <button
                  ...
                  className="p-2 rounded-theme-sm text-muted hover:text-on-surface hover:bg-surface-alt transition-colors"
                  aria-label="Settings"
                  title="Settings"
                >
                ...
                {isDashboard && user && (
                  <span className="hidden sm:block text-xs text-muted mr-1 ml-2 border-l border-border pl-3">
